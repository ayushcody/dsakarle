interface BacktrackingDiagramProps {
  diagramState: Record<string, unknown>
}

export default function BacktrackingDiagram({ diagramState }: BacktrackingDiagramProps) {
  return (
    <div className="rounded-[var(--radius)] border border-[var(--border)] bg-[var(--bg-secondary)] px-6 py-10 text-center">
      <p className="font-dmmono text-[13px] text-[var(--text-muted)]">Backtracking visualization coming soon.</p>
