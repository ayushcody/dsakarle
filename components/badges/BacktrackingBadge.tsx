...
export default function BacktrackingBadge(props: React.SVGProps<SVGSVGElement>) {
  ...
  return (
    ...
    <svg viewBox="0 0 90 90" width={90} height={90} className={className} {...props}>
      ...
      <path d="M 43 28 L 32 38" stroke="#C8900A" strokeWidth="1.2" strokeDasharray="2 2"/>
      <path d="M 47 28 L 58 38" stroke="#16A34A" strokeWidth="1.5"/>
      <circle cx="30" cy="40" r="3" fill="rgba(200,144,10,0.12)" stroke="#C8900A"/>
      <circle cx="60" cy="40" r="3" fill="rgba(200,144,10,0.35)" stroke="#C8900A" strokeWidth="1.5"/>
      <path d="M 28 42 L 24 50" stroke="#C8900A" strokeWidth="1.2" strokeDasharray="2 2"/>
      <path d="M 58 42 L 52 50" stroke="#C8900A" strokeWidth="1.2" strokeDasharray="2 2"/>
