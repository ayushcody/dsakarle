...
export default function SlidingWindowBadge(props: React.SVGProps<SVGSVGElement>) {
  ...
  return (
    ...
    <svg viewBox="0 0 90 90" width={90} height={90} className={className} {...props}>
      ...
      <rect x="34" y="38" width="24" height="14" fill="rgba(200,144,10,0.35)" stroke="#D4603A" strokeWidth="1.8"/>
